...
namespace WK.Libraries.BetterFolderBrowserNS
{
    ...
    public partial class BetterFolderBrowser : CommonDialog
    {
        ...
        {
            private BetterFolderBrowser WKComponent;
            private DesignerActionUIService designerActionUISvc = null;

            public WKComponentActionList(IComponent component) : base(component)
            {
                this.WKComponent = component as BetterFolderBrowser;
            ...
            public override DesignerActionItemCollection GetSortedActionItems()
            {
                DesignerActionItemCollection items = new DesignerActionItemCollection
                {
                    ...
                    new DesignerActionHeaderItem("Quick Options"),

                    // Add Designer items.
                    new DesignerActionPropertyItem("Multiselect",
                                     $"Multiselect Folders {new String(' ', 50)}", "Quick Options",
                                     GetPropertyDescriptor(this.Component, "Multiselect").Description),
                    
                    new DesignerActionPropertyItem("RootFolder",
                                     "Root Folder", "Quick Options",
                                     GetPropertyDescriptor(this.Component, "RootFolder").Description),

                    new DesignerActionPropertyItem("Title",
                                     "Dialog Title", "Quick Options",
                                     GetPropertyDescriptor(this.Component, "Title").Description)
            ...
            public bool Multiselect
            {
                get { return WKComponent.Multiselect; }
                set { SetValue(WKComponent, "Multiselect", value); }
            }

            [Editor(typeof(SelectedPathEditor), typeof(UITypeEditor))]
            public string RootFolder
            {
                get { return WKComponent.RootFolder; }
                set { SetValue(WKComponent, "RootFolder", value); }
            }

            public string Title
            {
                get { return WKComponent.Title; }
                set { SetValue(WKComponent, "Title", value); }
            }
